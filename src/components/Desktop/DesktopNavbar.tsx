      ...
      <nav className="flex space-x-4">
        {user ? (
          ...
          <>
            <Link
              to="/auth/login"
              className="flex items-center gap-3 rounded-lg border border-white p-3 transition-transform duration-150 hover:scale-105 hover:bg-blue-700 md:gap-1 md:p-2"
              activeProps={{
                className:
